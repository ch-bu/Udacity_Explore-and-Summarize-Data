...
scatterplot_ingredients <- function(xvariable, yvariable, xl, yl) {
  ...
  scat <- ggplot(food_germany, aes(x = xvariable, y = yvariable)) + 
...
scatterplot_ingredients(food_germany$fat_100g, food_germany$proteins_100g, "fat_100g", "proteins_100g")
```
...
scatterplot_ingredients(food_germany$nutrition_score_fr_100g, food_germany$saturated_fat_100g)
```
