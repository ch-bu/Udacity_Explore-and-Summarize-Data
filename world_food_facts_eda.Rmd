...
density_plot <- function(xvariable, fill, xl) {
  ...
  ggplot(food_germany, aes(x = xvariable, fill = fill)) +
...
density_plot(food_germany$carbohydrates_100g, food_germany$pnns_groups_1, "carbohydrates_100g")
```

Suggary snacks seem to contain more carbohydrates. Let's have a look at sugars

```{r Density plot sugars food category, echo=FALSE}
density_plot(food_germany$sugars_100g, food_germany$pnns_groups_1, "sugars_100g")
```

```{r Density plot proteins food category, echo=FALSE}
density_plot(food_germany$proteins_100g, food_germany$pnns_groups_1, "proteins_100g")
```

```{r Density plot fat food category, echo=FALSE}
density_plot(food_germany$fat_100g, food_germany$pnns_groups_1, "fat_100g")
```

```{r Density plot proteins nutrition_grade_fr, echo=FALSE}
density_plot(food_germany$proteins_100g, food_germany$nutrition_grade_fr, "proteins_100g")
```
